                ...
                <div className="join-wrap">
                    ...
                    <div className="join-content-wrap">
                        <div className="join-info-wrap">
                            ...
                            {/*<form action="http://localhost:8080/api/user/join" method="post">*/}
                                ...
                                <div className="join-info-form">
                                    ...
                                    <div className="info-wrap">
                                        ...
                                        <div className="input-btn-wrap">
                                            <input name={"email"} className="form-input-sm"
                                                   onChange={onEmailHandler} disabled={isEmailSend}/>
